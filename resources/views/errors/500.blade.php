...
<div style="min-height: 95vh; 
	...
	<div class="container  mt-5 pt-5 pt-md-0 mt-md-0" style="">
		<div class="row col-12 pt-6 px-0 justify-content-center" style="padding-top: 20px;">
			<div class="row justify-content-center align-items-center" style="min-height: 80vh;margin: 0% 0px;">
				<div class=" justify-content-center align-items-center py-5 main-nafez-box-styles" style=";border-radius: 12px">
					<div class="col text-center py-5">
						...
						<h4 class="text-center"> {{ App::getLocale() == 'en'?'An error occurred during the processing of your application':'حدث خطأ أثناء معالجة طلبك' }}</h4>
