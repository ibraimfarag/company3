@extends('layouts.admin', ['page_title' => 'traffic'])
@section('content')
...
<div class="col-12   row p-4" style="padding: 30px 0px;position: relative;{{ $settings['dashboard_dark_mode'] != '1'?'background: #fff':'' }};overflow-x: auto;">
    <table id="myTable" class="table table-striped table-bordered col-12 " style="padding: 0px;min-width: 1200px;">
        <thead>
            <tr>
                <th style="font-size: 12px">id</th>
                <th style="font-size: 12px">Came from</th>
                <th style="font-size: 12px">Go to</th>
                
                <th style="font-size: 12px">ip</th> 
                <th style="font-size: 12px">Device Details</th> 
