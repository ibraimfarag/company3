            ...
            <div class="col-12 px-0">
                <div class="col-12 p-0 row">
                    <div class="col-12 col-lg-4 py-3 px-3">
                        <span class="fal fa-users"></span> Managers
                    </div>
                    ...
                    <div class="col-12 col-lg-4 p-2 text-lg-end">
                        @can('users-create')
                            <a href="{{ route('admin.users.create') }}">
                                <span class="btn btn-primary"><span class="fal fa-plus"></span> Add New</span>
                            </a>
                        @endcan
                    </div>
                </div>
                                    ...
                                    <td>
                                        @can('users-read')
                                            <a href="{{ route('admin.users.show', $user) }}">
                                                <span class="btn  btn-outline-primary btn-sm font-small mx-1">
                                                    <span class="fal fa-search "></span> Show
                                                </span>
                                            </a>
                                        @endcan
                                        ...
                                        {{-- @can('notifications-create')
                                            <a href="{{ route('admin.notifications.index', ['user_id' => $user->id]) }}">
                                                <span class="btn  btn-outline-primary btn-sm font-small mx-1">
                                                    <span class="fal fa-bells"></span> notifications
                                                </span>
                                            </a>
                                        ...
                                        @can('user-roles-update')
                                            <a href="{{ route('admin.users.roles.index', $user) }}">
                                                <span class="btn btn-outline-primary btn-sm font-small mx-1">
                                                    <span class="fal fa-key "></span> Roles
                                                </span>
                                            </a>
                                        @endcan
                                        ...
                                        @can('users-update')
                                            <a href="{{ route('admin.users.edit', $user) }}">
                                                <span class="btn  btn-outline-success btn-sm font-small mx-1">
                                                    <span class="fal fa-wrench "></span> Control
                                                </span>
                                            </a>
                                        @endcan
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1"
                                                ...
                                                @can('users-update')
                                                    <li><a class="dropdown-item font-1"
                                                            href="{{ route('admin.users.access', $user) }}"><span
                                                                class="fal fa-eye"></span> Login</a></li>
                                                @endcan
                                                ...
                                                @can('users-update')
                                                    <li><a class="dropdown-item font-1"
                                                            href="{{ route('admin.traffics.logs', ['user_id' => $user->id]) }}"><span
                                                                class="fal fa-boxes"></span> Activity monitoring<span
                                                                class="badge bg-danger">{{ $user->logs_count }}</span></a></li>
                                                @endcan
                                            </ul>
                                        </div>
