...
<div class="col-12 py-0 px-3 row">
    <div class="col-12  pt-4 card" style="min-height: 80vh">
        <div class="col-12 px-3">
            <h5>View Message Number {{$contact->id}} coming from {{$contact->name}}</h5>
        </div>
	                    ...
	                    <div style="width:70px;" class="text-center d-none d-md-flex align-items-start">
	                        <div class="d-inline-block">
	                            ...
	                            @else
	                                ...
	                                <img src="{{ url('images/default/avatar.png') }}" style="width: 45px;height: 45px;display: inline-block;border-radius: 50%!important;padding: 3px;" class="mx-auto" alt="صورة المستخدم">
	                                <span style="display: inline-block;position: relative;top: 6px; " class="px-2 pt-0  float-end kufi"> </span>
        ...
        {{-- <div class="col-12  px-3 py-1 mt-4">
            <form method="POST" action="{{route('admin.contact-replies.store')}}" enctype="multipart/form-data">
                ...
                <div class="col-12 p-0">
                    <button class="btn btn-primary">send a reply</button>
                </div>
            </form>
        </div> --}}
    </div>
