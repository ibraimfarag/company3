...
@section('content')
            ...
            <div class="col-12 px-0">
                <div class="col-12 p-0 row">
                    <div class="col-12 col-lg-4 py-3 px-3">
                        <span class="fas fa-pages"></span> Section Three (Our Management) 
                    </div>
                    <div class="col-12 col-lg-4 p-0">
                    </div>
                    <div class="col-12 col-lg-4 p-2 text-lg-end">
                        @can('pages-create')
                            <a data-bs-toggle="modal" data-bs-target="#addNewOurManagement">
                        ...
                        <tbody>
                            @foreach ($our_management as $value)
                                <tr>
                                    ...
                                    <td style="white-space: inherit;">{{ $value->name }}</td>
                                    <td style="white-space: inherit;">{{ $value->name_ar }}</td>
                                    <td style="white-space: inherit;">{{ $value->description }}</td>
                                    <td style="white-space: inherit;">{{ $value->description_ar }}</td>
                                    <td>
                                        @can('pages-update')
                                        <a data-bs-toggle="modal" data-bs-target="#UpdateOurManagement{{ $value->id }}">
                                        ...
                                        @endcan
                                        @can('pages-delete')
                                        <form method="POST" action="{{route('admin.pages.about.delete_our_management',$value->id)}}" class="d-inline-block">@csrf @method("DELETE")
    ...
    <!-- Modal Add our_management -->
    <div class="modal fade" id="addNewOurManagement" tabindex="-1" role="dialog" aria-labelledby="addNewOurManagement"
        aria-hidden="true">
                ...
                <div class="modal-body p-0">
                    <div class="card card-plain">
                        ...
                        <div class="card-body pb-3">
                            <form id="validate-form" role="form text-left" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.pages.about.add_our_management',$page)}}">
                                @csrf
                                @method("PUT")
                                ...
                                <div class="col-md-6">
                                    <label>name (EN)</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Name EN">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label>name (AR)</label>
                                    <div class="input-group mb-3">
                                        <input type="text" name="name_ar" value="{{old('name_ar')}}" class="form-control" placeholder="Name AR">
                                    </div>
                                </div>
    ...
    <!-- Modal Update our_management -->
    @foreach ($our_management as $value)
        <div class="modal fade" id="UpdateOurManagement{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="UpdateOurManagement{{ $value->id }}"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div class="card-body pb-3">
                                <form id="validate-form" role="form text-left" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.pages.about.update_our_management', $value->id)}}">
                                    @csrf
                                    @method("PUT")
                                    ...
                                    <div class="col-md-6">
                                        <label>name (EN)</label>
                                        <div class="input-group mb-3">
                                            <input type="text" name="name" value="{{old('name',$value)}}" class="form-control" placeholder="name EN">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label>name (AR)</label>
                                        <div class="input-group mb-3">
                                            <input type="text" name="name_ar" value="{{old('name_ar',$value)}}" class="form-control" placeholder="name AR">
                                        </div>
                                    </div>
