...
@section('content')
            ...
            <div class="col-12 px-0">
                <div class="col-12 p-0 row">
                    <div class="col-12 col-lg-4 py-3 px-3">
                        <span class="fas fa-pages"></span> Section two (OurValues) 
                    </div>
                    <div class="col-12 col-lg-4 p-0">
                    </div>
                    <div class="col-12 col-lg-4 p-2 text-lg-end">
                        @can('pages-create')
                            <a data-bs-toggle="modal" data-bs-target="#addNewOurValues">
                        ...
                        <tbody>
                            @foreach ($our_values as $value)
                                <tr>
                                    ...
                                    <td>
                                        @can('pages-update')
                                        <a data-bs-toggle="modal" data-bs-target="#UpdateOurValues_{{ $value->id }}">
                                        ...
                                        @endcan
                                        @can('pages-delete')
                                        <form method="POST" action="{{route('admin.pages.about.delete_our_values',$value->id)}}" class="d-inline-block">@csrf @method("DELETE")
    ...
    <!-- Modal Add our_values -->
    <div class="modal fade" id="addNewOurValues" tabindex="-1" role="dialog" aria-labelledby="addNewOurValues"
        aria-hidden="true">
                ...
                <div class="modal-body p-0">
                    <div class="card card-plain">
                        ...
                        <div class="card-body pb-3">
                            <form id="validate-form" role="form text-left" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.pages.about.add_our_values',$page)}}">
                                @csrf
                                @method("PUT")
    ...
    <!-- Modal Update our_values -->
    @foreach ($our_values as $value)
        <div class="modal fade" id="UpdateOurValues_{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="UpdateOurValues_{{ $value->id }}"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div class="card-body pb-3">
                                <form id="validate-form" role="form text-left" class="row" enctype="multipart/form-data" method="POST" action="{{route('admin.pages.about.update_our_values', $value->id)}}">
                                    @csrf
                                    @method("PUT")
