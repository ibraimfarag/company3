  ...
  <div class="modal-dialog" style="width:394px;max-width: 100%">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="changeAvatarLabel">Edit Personal Photo
        </h5>
        ...
        <div class="col-12 p-2" style="background: #fff;overflow: hidden;position: relative;max-width: 100%!important">
            ...
            <div class="col-12 text-left
             mt-3">
                ...
                <button class="btn btn-primary mx-1 font-1 save-image" >Edit Photo</button>
            </div>
        </div>
					...
					<div class="col-12 p-0 main-box shadow">
						<div class="col-12 px-0">
							<div class="col-12 px-3 py-3">
							 	<span class="fal fa-info-circle"></span>	Base Data
							</div>
                ...
                <form method="POST" action="{{route('admin.profile.update-email')}}" >
                    ...
                    <div class="col-12 p-0 main-box shadow">
                        ...
                        <div class="col-12 p-3">
                            ...
                            <div class="col-12 p-2">
                                <div class="col-12 pt-3">
                                    <button class="btn btn-primary">Change the Email</button>
                            ...
                            <div class="col-12 p-2">
                                <div class="col-12 pt-3">
                                    <div class="alert alert-warning">
                                        Prefer to use a password made up of private characters, numbers and tags such as (% $ # @)                                    </div>
                                </div>
                            </div>
                            <div class="col-12 p-2">
                                <div class="col-12">
