                    ...
                    <form method="POST" action="{{ route('login') }}" class="row m-0">
                        ...
                        <div class="form-group row mb-4 col-12 col-lg-6   px-0 pt-2 ">
                            <div class="col-md-12 px-2 pt-4" style="position: relative;">
                                <label for="email" class="col-form-label text-md-right mb-1 font-small px-2 py-1 d-inline" style="background:#f4f4f4;position: absolute;top: 17px;right: 20px; border-radius: 3px!important">{{ App::getLocale()=='en'?'Email':'البريد الالكتروني' }}</label>
                        ...
                        <div class="form-group row mb-4 col-12 col-lg-6   px-0 pt-2 ">
                            <div class="col-md-12 px-2 pt-4" style="position: relative;">
                                <label for="password" class="col-form-label text-md-right mb-1 font-small px-2 py-1 d-inline" style="background:#f4f4f4;position: absolute;top: 17px;right: 20px;border-radius: 3px!important">{{ App::getLocale()=='en'?'Password':'كلمة المرور' }}</label>
                        ...
                        <div class="col-12 px-4 py-2">
                            ...
                            {{ App::getLocale()=='en'?'Help':'مساعدة' }}
                            </div>
                            <ul style="list-style:none;" class="p-0 m-0">
                                
                                @if (Route::has('password.request'))
                                <li class="d-block"><a href="{{ route('password.request') }}" class="naskh py-2 d-block" style="text-decoration: none!important;"><span class="fa fa-circle font-small" ></span>
                                    {{ App::getLocale()=='en'?'Forgot your password?':'نسيت كلمة المرور' }} </a></li>
                                @endif
                            </ul>
                        </div>
        ...
        <div class="col-12 col-lg-6 d-none d-lg-flex text-center p-0 d-flex align-items-center justify-content-center row position-relative" style="">
            <div class="overlap-grid overlap-grid-2">
                <div class="item mx-auto">
                    ...
                    <div class="col-12 p-0 align-items-center py-5 justify-content-center d-flex svg-animation" style="background-image: url('{{ asset('images/login.svg') }}');background-size: cover;padding-top: 57%;background-position: center;height: 342px;z-index: 1;position: relative;">
                    </div>
